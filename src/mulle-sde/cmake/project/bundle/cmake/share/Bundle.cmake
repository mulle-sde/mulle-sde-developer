...
if( NOT BUNDLE_IDENTIFIER)
   string( MAKE_C_IDENTIFIER "${BUNDLE_NAME}" BUNDLE_IDENTIFIER)
endif()

include( StringCase)

if( NOT BUNDLE_UPCASE_IDENTIFIER)
   snakeCaseString( "${BUNDLE_IDENTIFIER}" BUNDLE_UPCASE_IDENTIFIER)
   string( TOUPPER "${BUNDLE_UPCASE_IDENTIFIER}" BUNDLE_UPCASE_IDENTIFIER)
endif()
if( NOT BUNDLE_DOWNCASE_IDENTIFIER)
   snakeCaseString( "${BUNDLE_IDENTIFIER}" BUNDLE_DOWNCASE_IDENTIFIER)
   string( TOLOWER "${BUNDLE_DOWNCASE_IDENTIFIER}" BUNDLE_DOWNCASE_IDENTIFIER)
endif()
